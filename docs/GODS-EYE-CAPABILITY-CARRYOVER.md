...
| Click-to-track camera lock, fading trail, metadata card | `cockpitTracking.js`, `camera.js`, `cameraVerbs.js` | MIT code | Port the camera maths and trail entity logic behind the adapter. This is the signature interaction. |
